            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth::user()->role === 'admin')
                        ...
                        <x-nav-link :href="route('admin.patients')" :active="request()->routeIs('admin.patients')">
                            {{ __('Pacientes') }}
                        </x-nav-link>

                        {{-- NUEVO: Servicios (Precios) --}}
                        <x-nav-link :href="route('admin.services')" :active="request()->routeIs('admin.services')">
                            {{ __('Servicios') }}
                        </x-nav-link>

                        {{-- NUEVO: Reportes (Estadísticas) --}}
                    ...
                    @else
                        ...
                        <x-nav-link :href="route('patient.manager')" :active="request()->routeIs('patient.manager')">
                            {{ __('Mis Hijos') }}
                        </x-nav-link>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            @if (Auth::user()->role === 'admin')
                ...
                <x-responsive-nav-link :href="route('admin.patients')" :active="request()->routeIs('admin.patients')">
                    {{ __('Pacientes') }}
                </x-responsive-nav-link>
            ...
            @else
                {{-- MÓVIL PACIENTE --}}
                <x-responsive-nav-link :href="route('patient.manager')" :active="request()->routeIs('patient.manager')">
                    {{ __('Mis Hijos') }}
                </x-responsive-nav-link>
